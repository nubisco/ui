...
See [`useShellSlot`](/composables/use-shell-slot) for the full reference.
...
import BrandShield from '../ui/components/icons/BrandShield.vue'
import WorkflowNode from '../ui/components/icons/WorkflowNode.vue'
