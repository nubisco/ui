...
<preview style-grid>
  ...
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
    ...
    <nb-grid dir="col" grid="15" class="grid-demo-item span-b">15</nb-grid>
  </nb-grid>
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
  ...
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
    <nb-grid dir="col" grid="3" class="grid-demo-item">3</nb-grid>
    <nb-grid dir="col" grid="13" class="grid-demo-item span-b">13</nb-grid>
  </nb-grid>
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
  ...
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
    <nb-grid dir="col" grid="5" class="grid-demo-item">5</nb-grid>
    <nb-grid dir="col" grid="11" class="grid-demo-item span-b">11</nb-grid>
  </nb-grid>
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
  ...
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
    <nb-grid dir="col" grid="7" class="grid-demo-item">7</nb-grid>
    <nb-grid dir="col" grid="9" class="grid-demo-item span-b">9</nb-grid>
  </nb-grid>
  <nb-grid dir="row" class="grid-demo-row" gap="sm">
