...
Use it when the reorder logic is yours, as in a document editor or a data table. For a plain vertical list, [`NbReorderList`](/components/reorder-list) already owns the whole job.
