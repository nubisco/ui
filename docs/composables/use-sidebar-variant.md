...
Name a key and namespace it per product, the same rule as [useTheme](/composables/use-theme): two Nubisco products on one origin would otherwise overwrite each other's choice.
