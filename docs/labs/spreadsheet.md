...
`NbSpreadsheet` is a spreadsheet-style data grid. It shares a design language with [`NbBoard`](/components/board): dense rows, hairline borders, a sticky header, an inset focus ring, and tabular numerics throughout.
